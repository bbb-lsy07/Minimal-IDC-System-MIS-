    ...
    <div class="col-md-5">
        <div class="mis-card shadow-lg p-4">
            <div class="text-center mb-4">
                <h2 class="border-0 mb-2" style="color: #3cb2b8;"><i class="fas fa-user-plus me-2"></i>用户注册</h2>
            ...
            <form method="post" action="<?= e(url_with_action('index.php', 'register')) ?>">
                ...
                <div class="mb-4">
                    <label class="form-label fw-bold">设置密码（至少8位字符）</label>
                    <div class="input-group input-group-lg">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-success btn-lg" type="submit">
                        <i class="fas fa-user-check me-2"></i>立即创建账户
                    </button>
                </div>

                <div class="text-center mt-3">
                    已有账号？ <a href="<?= e(url_with_action('index.php', 'login')) ?>" class="text-primary fw-bold">立即登录</a>
                </div>
            </form>
        </div>
    </div>
